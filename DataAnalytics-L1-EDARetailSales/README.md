...
1. Inspection: Reviewed the dataset structure using ".shape", ".info()", and ".describe()".
...
- Electronics dominated total revenue, generating 1,200,500, significantly outperforming the other categories.
...
- Age Distribution: Customers aged 56–65 recorded the highest representation and transaction volume, while the under-18 age group had the lowest activity.
